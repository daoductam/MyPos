...
import com.tamdao.payload.StoreAnalysis.BranchSalesDTO;
import com.tamdao.payload.StoreAnalysis.PaymentInsightDTO;
import com.tamdao.payload.StoreAnalysis.TimeSeriesPointDTO;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    List<Order> findOrdersFiltered(@Param("branchId") Long branchId,
                                   @Param("customerId") Long customerId,
                                   @Param("cashierId") Long cashierId,
                                   @Param("paymentType") com.tamdao.domain.PaymentType paymentType);
...
""")
    ...
    @Query("""
    SELECT new com.tamdao.payload.StoreAnalysis.TimeSeriesPointDTO(
        o.createdAt,
        SUM(o.totalAmount)
    )
    FROM Order o
...
""")
    ...
    @Query("""
        SELECT new com.tamdao.payload.StoreAnalysis.PaymentInsightDTO(
            o.paymentType,
            SUM(o.totalAmount)
        )
        FROM Order o
    ...
    """)
        ...
        @Query("""
        SELECT new com.tamdao.payload.StoreAnalysis.BranchSalesDTO(
            o.branch.name,
            SUM(o.totalAmount)
        )
        FROM Order o
