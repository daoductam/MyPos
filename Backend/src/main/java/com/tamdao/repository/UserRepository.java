...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	List<User> findByStoreAndRoleIn(com.tamdao.modal.Store store, List<UserRole> roles);
	List<User> findByBranchAndRoleIn(com.tamdao.modal.Branch branch, List<UserRole> roles);
...
int countByStoreAdminIdAndRoles(@Param("storeAdminId") Long storeAdminId,
	...
	@Query("""
    SELECT new com.tamdao.payload.dto.UserDTO(
		u.id,
		u.email,
    ...
    AND u.role = com.tamdao.domain.UserRole.ROLE_BRANCH_CASHIER
""")
...
//        AND u.role = com.tamdaoao.domain.UserRole.ROLE_BRANCH_CASHIER
//    """)
